...
const Experience: React.FC = () => {
  return (
    <section id="experience" className="py-24 px-6 bg-white scroll-mt-24">
      <div className="max-w-[1600px] mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h2 className="text-4xl font-bold">Work Experience</h2>
          <p className="text-slate-500">Professional internships and corporate exposure</p>
        </div>
        ...
        <div className="space-y-8">
          {EXPERIENCE.map((exp, idx) => (
            <div key={idx} className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px before:bg-indigo-500/20">
              ...
              <div className="glass p-8 rounded-3xl border-slate-100 shadow-sm hover:shadow-md transition-all">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                  ...
                  <span className="bg-indigo-50 text-indigo-600 px-4 py-1.5 rounded-full text-sm font-bold self-start">
                    {exp.duration}
                  </span>
                </div>
