    ...
    <section id="education" className="py-24 px-6">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-slate-600 text-xl">My educational journey and qualifications</p>
        </div>
            ...
            {EDUCATION_DATA.map((edu, index) => (
              <div key={index} className={`relative grid md:grid-cols-2 gap-8 items-center ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                ...
                <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 z-10">
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 border-4 border-white shadow-lg animate-pulse"></div>
                </div>
                ...
                {index % 2 === 0 ? (
                  <>
                    ...
                    <div className="md:text-right md:pr-12">
                      <div className={`inline-block bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all hover:scale-105 border-2 border-indigo-200 ${index % 2 === 0 ? 'md:ml-auto' : ''}`}>
                  ...
                  <>
                    ...
                    <div className="md:text-left md:pl-12">
                      <div className="inline-block bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all hover:scale-105 border-2 border-purple-200">
                        <div className="space-y-3">
                          {/* Duration badge */}
